...
var quality = 0.8; // initializing the compressed image

compressImage(originalImage, resizingFactor, quality);
fileInput.addEventListener("change", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var _fileInput$files, file;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _fileInput$files = _slicedToArray(fileInput.files, 1), file = _fileInput$files[0]; // storing the original image

            _context.next = 3;
            return fileToDataUri(file);

          case 3:
            originalImage.src = _context.sent;
...
resizingElement.oninput = function (e) {
  resizingFactor = parseInt(e.target.value) / 100;
  compressImage(originalImage, resizingFactor, quality);
};

qualityElement.oninput = function (e) {
    ...
    fetch("https://api.imgur.com/3/image/", {
      ...
      if ((response === null || response === void 0 ? void 0 : response.status) === 403) {
        ...
        response.json().then(function (jsonResponse) {
          var _jsonResponse$data;

          alert("URL: ".concat((_jsonResponse$data = jsonResponse.data) === null || _jsonResponse$data === void 0 ? void 0 : _jsonResponse$data.link));
        });
...
function compressImage(imgToCompress, resizingFactor, quality) {
  ...
  context.drawImage(imgToCompress, 0, 0, originalWidth * resizingFactor, originalHeight * resizingFactor); // reducing the quality of the image
